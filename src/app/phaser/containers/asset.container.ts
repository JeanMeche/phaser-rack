...
export class AssetContainer extends Phaser.GameObjects.Container {
  public static width = 350 * window.devicePixelRatio;
  public static height = 30 * window.devicePixelRatio;
  ...
  public override width = AssetContainer.width;
  ...
  //     for (const asset of this.scene.rackConfig) {
  //         if (asset.id === assetId) {
